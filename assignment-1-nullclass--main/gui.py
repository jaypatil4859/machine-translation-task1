...
def translate_to_hindi(sentence, english_to_hindi):
    ...
    if not (start_time <= current_time <= end_time):
        return "", "Translation feature is available only between 9 PM and 10 PM."
...
def on_translate_click():
    sentence = entry.get()
    english_to_hindi = load_translations("C:\\Users\\Jay\\Machine_Translation-main\\assignment--7-nullclass--main\\data7\\english.txt", "C:\\Users\\Jay\\Machine_Translation-main\\assignment--7-nullclass--main\\data7\\hindi.txt")
